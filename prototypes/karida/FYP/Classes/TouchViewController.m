...
- (void)viewDidLoad {
	...
	//NSLog(@"image size : w&h = %@ %@", self.image.size.width,self.image.size.height );
	//NSLog(@"imageview : w&h = %@ %@", self.imageView.frame.size.width, self.imageView.frame.size.height );
	//NSLog(@"scrollview : w&h = %@ %@", self.view.frame.size.width, self.view.frame.size.height );
